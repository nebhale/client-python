...
class TestBinding(unittest.TestCase):
    ...
    def test_get_provider_invalid_key(self):
        ...
        self.assertIsNone(binding.get_provider(b))
    ...
    def test_get_provider_valid_key(self):
        ...
        self.assertEqual('test-provider-1', binding.get_provider(b))

    def test_get_type_invalid_binding(self):
        b = binding.DictBinding('test-name', {})

        self.assertRaises(ValueError, lambda: binding.get_type(b))
    ...
    def test_get_type_valid_binding(self):
        ...
        self.assertEqual('test-type-1', binding.get_type(b))
